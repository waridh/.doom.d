...
(doom! :input
       ...
       ;; parinfer          ; turn lisp into python, sort of. It's not great
       ...
       (org +pretty +noter +contacts +gnuplot +hugo +roam +dragndrop +journal +present +pomodoro)               ; organize your plain life in plain text
       ;;php               ; perl's insecure younger brother
       plantuml          ; diagrams for confusing people more
       ;;purescript        ; javascript, but functional
       (python +lsp +tree-sitter +peotry)            ; beautiful is better than ugly
       ...
       (sh +tree-sitter +lsp +fish)                ; she sells {ba,z,fi}sh shells on the C xor
       ;;sml
